...
{ 
/*3.Crea una clase en JAVA llamada FicheroStream que contenga métodos (como quieras llamarlos) sin parámetros y que haga cada uno lo siguiente:
	a.	Creación del fichero.
	b.	Apertura del fichero.
	c.	Cierre del fichero.
	d.	Lectura de los datos del fichero.
	e.	Escritura de datos en el fichero.
	Cada uno de los métodos después irá implementado en otra clase que contenga el main y actúe como menú de opciones de los métodos vistos.
*/
